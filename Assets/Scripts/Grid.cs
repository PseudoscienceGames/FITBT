...
public class Grid : MonoBehaviour
{
	...
	public Vector3 GridToWorld(Vector2 gridLoc, float height)
	{
	...
	//Fixes moveDir
	public int MoveDirFix(int moveDir)
	{
		while (moveDir > 5)
			moveDir -= 6;
		while (moveDir < 0)
	...
	public Vector2 MoveTo(Vector2 gridLoc, int moveDir)
	{
	...
	public List<Vector2> FindAdjacentGridLocs(Vector2 gridLoc)
	{
